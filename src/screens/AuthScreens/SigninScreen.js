import { Text, View, TextInput, TouchableOpacity, Image, KeyboardAvoidingView, Platform, TouchableWithoutFeedback, Keyboard, Dimensions, PixelRatio} from "react-native";
            ...
            <TouchableWithoutFeedback className={'w-full h-full'} onPress={Keyboard.dismiss} accessible={false}>
                <SafeAreaView style={[{height: height}]} className={`${props.theme === "light" ? "" : props.theme === "dark" ? "bg-[#222831]" : "bg-white"} w-full flex-col relative items-center`}>
                    ...
                    <View className="h-[40%] w-full flex items-center">
                        ...
                        <View className={`h-[55%] ${props.theme === "dark" ? "border-gray-900" : "bg-white"} w-[90%] rounded-[40px] flex items-center justify-center mt-5`}>
                            <TextInput
                        ...
                        <View className="w-full h-fit mt-5 flex flex-row items-center justify-end">
                            <TouchableOpacity className="text-nowrap max-w-[40%] w-fit pr-7" onPress={() => {
                                    ...
                                    <Text style={{fontSize: getFontSize(14)}} className={`${props.theme === "dark" ? "text-white" : "text-black"} text-right w-fit font-medium tracking-tight`}>Forgot Password?</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                    <View className="h-[30%] w-[90%] mt-4 rounded-[40px] py-5 flex items-center justify-evenly bg-white">
                        {errorVisible && 
                        ...
                        <TouchableOpacity className="bg-[#186F65] shadow-sm w-[85%] h-[40%] rounded-[50px] flex justify-center items-center" onPress={handleEmailPasswordSignIn}>
                            <Text style={{fontSize: getFontSize(20)}} className="text-white font-bold tracking-tight">Sign in</Text>
                        </TouchableOpacity>
                        <View className="mt-3 flex-row items-center justify-center">
                            <Text style={{fontSize: getFontSize(14)}} className={`${props.theme === "dark" ? "text-white" : "text-black"} font-light tracking-tight`}>Don't have an account? </Text>
                            <TouchableOpacity onPress={() => {
                                navigation.navigate("Signup")
                            }}>
                                <Text style={{fontSize: getFontSize(14)}} className="text-[#186F65] font-bold tracking-tight">Sign up</Text>
                            </TouchableOpacity> 
                        </View>
                    </View>
                </SafeAreaView>
