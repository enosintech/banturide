...
const NotificationsScreen = (props) => {
    ...
    return(
        <SafeAreaView className={`${props.theme === "dark" ? "bg-[#222831]" : "bg-gray-100"} w-full h-full`}>
            <View className={`w-full h-[18%]`}>
                ...
                <View className={`w-full h-[50%] items-center bg-inherit justify-center`}>
                    <View className={`w-[95%] mt-1 h-[50%] bg-white flex-row shadow-2xl rounded-2xl`}>
                        <TouchableOpacity className={`w-[50%] h-full items-center justify-center rounded-2xl ${notifToggle === "unread" ? "bg-[#186f65]" : "bg-white" }`} onPress={() => {
                            ...
                            <Text style={{fontFamily: "os-reg"}} className={`${notifToggle === "unread" ? "text-white" : "text-black"}`}>Unread</Text>
                        </TouchableOpacity>
                        <TouchableOpacity className={`w-[50%] h-full items-center justify-center rounded-2xl ${notifToggle === "read" ? "bg-[#186f65]" : "bg-white" }`} onPress={() => {
                            ...
                            <Text style={{fontFamily: "os-reg"}} className={`${notifToggle === "read" ? "text-white" : "text-black"}`}>Read</Text>
                        </TouchableOpacity>
                    </View>
                </View>
                <View className={`border-b-[0.25px] border-solid ${props.theme === "dark" ? "border-gray-900" : "border-gray-400"}`}></View>
            </View>
            <View className={`w-full h-[65%] bg-inherit`}>
                <View className={`w-full h-[8%] ${props.theme === "dark" ? "bg-[#222831] border-gray-900" : " border-gray-400"} border-b-[0.25px] border-t-[0.25px] border-solid flex-row justify-end items-center px-3`}>
                    <TouchableOpacity className={`flex-row h-[80%] items-center rounded-2xl p-1 ${notifToggle === "all" ? "bg-[#186f65]" : "bg-white"} shadow-2xl`} onPress={() => {
                        setNotifToggle("all")
                    }}>
                        <Ionicons name="logo-stackoverflow" size={15} color={`${notifToggle === "all" ? "white" : "black"}` }/>
                        <Text style={{fontFamily: "os-reg"}} className={`${notifToggle === "all" ? "text-white" : "text-black"} text-[13px]`}> View all</Text>
                    </TouchableOpacity>
                </View>
                {
                    notifToggle === "unread"
